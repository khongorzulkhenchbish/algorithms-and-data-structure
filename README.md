...
|1762. Buildings With an Ocean View|Array|Medium|Instead of iterating from left to right go opposite direction. If you see a building higher than the last added one, then add that to the list. Return the reversed list indices.|
